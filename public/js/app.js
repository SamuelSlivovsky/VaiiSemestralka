...
/* harmony import */ var _hamburger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hamburger */ "./resources/js/hamburger.js");
...
/* harmony import */ var _changeTries__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./changeTries */ "./resources/js/changeTries.js");
...
var ascendType = document.querySelectorAll(".ascend-type");
...
if (ascendType) {
  ...
  for (var i = 0; i < ascendType.length; i++) {
    _loop(i);
  }
}
...
var inputTries = document.querySelectorAll(".tries-input");

if (inputTries) {
  var _loop = function _loop(i) {
    var element = inputTries[i];
    element.addEventListener("input", function () {
      sendToApi(element.dataset.id, element.value);
    });
  };

  for (var i = 0; i < inputTries.length; i++) {
    _loop(i);
  }
}

function sendToApi(id, value) {
  axios.post("/api/tries", {
    id: parseInt(id),
